...
├── diagram_layout.py # Где на странице оказывается каждая группа
├── mermaid_syntax.py # Как это записывается в мермейде
└── settings.py
...
написана её первая строка, а `diagram_layout.PLACEMENT_OF_NODE_GROUP` говорит, в какую часть
